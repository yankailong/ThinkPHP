...
<div class="content">
    ...
    <form action="/index.php/Admin/Goods/add" method="post" id="tab" enctype="multipart/form-data">
        <ul class="nav nav-tabs">
          ...
          <li role="presentation"><a href="/Public/Admin/#attr" data-toggle="tab">商品属性</a></li>
          <li role="presentation"><a href="/Public/Admin/#pics" data-toggle="tab">商品相册</a></li>
        </ul>
        <div class="tab-content">
            ...
            <div class="tab-pane fade in" id="attr">
                <div class="well">
                    ...
                    <div>
                        ...
                        <label>商品型号：</label>
                        <input type="text" name="type_id" value="" class="input-xlarge">
                        <label>商品重量：</label>
                        <input type="text" name="" value="" class="input-xlarge">
                    </div>
                </div>
            ...
            <div class="tab-pane fade in" id="pics">
                <div class="well">
                        <div>[<a href="/Public/Admin/javascript:void(0);" class="add">+</a>]商品图片：<input type="file" name="goods_pics[]" value="" class="input-xlarge"></div>
                </div>
            </div>
...
<script type="text/javascript">
    $(function(){
        $('.add').click(function(){
            var add_div = '<div>[<a href="/Public/Admin/javascript:void(0);" class="sub">-</a>]商品图片：<input type="file" name="goods_pics[]" value="" class="input-xlarge"></div>';
