...
<div class="content">
    ...
    <div class="well">
        <!-- search button -->
        <form action="/index.php/Admin/Manager/index?" method="get" class="form-search">
        ...
        <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
                ...
                <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($k % 2 );++$k;?><tr class="success">
                        ...
                        <td><?php echo ($vol["nickname"]); ?>子</td>
                        <td><?php echo ($vol["nickname"]); ?></td>
                        <td><?php echo ($vol["status"]); ?></td>
                        <td><?php echo ($vol["update_time"]); ?></td>
                        <td>
                            <a href="/index.php/Admin/Manager/edit/id/<?php echo ($vol["id"]); ?>"> 编辑 </a>
                            <a href="/index.php/Admin/Manager/delete" onclick="if(confirm('确认删除？')) location.href='/index.php/Admin/Manager/delete/id/<?php echo ($vol["id"]); ?>'"> 删除 </a>
                            <a href="/Public/Admin/javascript:void(0);"> 重置密码 </a>
                        </td>
